...
#If you want to create response on same topic then you can use below code instead of above code
# chain = RunnableParallel({
...
print(f"Short explanation: {result['short']}")
print("-------------------------------------------------------------------")
print(f"Detailed explanation: {result['detailed']}")